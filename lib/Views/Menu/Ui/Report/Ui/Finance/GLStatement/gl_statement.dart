...
class _DesktopState extends State<_Desktop> {
  ...
  String? _extractTxnType(String? reference) {
    ...
    final txnTypes = ['SALE', 'PRCH', 'ATAT', 'CHDP', 'CHWL', 'GLAT', 'SLRY', 'PLCL', 'CRFX', 'PRJT','XPNS'];
  ...
  void _handleTransactionTap(GlRecord stmt) {
          ...
          builder: (context, state) {
            ...
            return Form(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    // ... (rest of your existing form fields - keep them as is)
                    // Keep all your Row with GenericTextField, BranchDropdown, CurrencyDropdown, DatePickers
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          SizedBox(
                            width: dateWith,
                            child: Text(tr.txnDate, style: Theme.of(context).textTheme.titleSmall),
                          ),
                          SizedBox(
                            width: refWidth,
                            child: Text(tr.referenceNumber, style: Theme.of(context).textTheme.titleSmall),
                          ),
                          Expanded(
                            child: Text(tr.narration, style: Theme.of(context).textTheme.titleSmall),
                          ),
                          SizedBox(
                            width: amountWidth,
                            child: Text(
